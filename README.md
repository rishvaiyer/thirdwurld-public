...
Thirdwurld was originally developed on top of Hyperfy. The public repository is a curated implementation, not a mirror or history export of the private project. The current modules are engine-independent. Future Hyperfy-derived code will preserve clear upstream attribution.
